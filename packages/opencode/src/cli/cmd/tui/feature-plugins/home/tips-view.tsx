...
const TIPS = [
  ...
  "PIXI auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "PIXI auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "PIXI uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent PIXI from reading sensitive files",
  ...
  "Run {highlight}pixicode serve{/highlight} for headless API access to PIXI",
  ...
  "Use {highlight}/connect{/highlight} with PIXI Pro for curated, tested models",
